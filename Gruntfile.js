...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {
            ...
            dataSync: {
                src: ['src/aerogear.core.js', 'external/uuid/uuid.js', 'external/jsondiffpatch/jsondiffpatch.min.js', 'src/data-sync/aerogear.datasync.js' ],
                dest: 'dist/<%= pkg.name %>.custom.js'
            }
        },
        qunit: {
    ...
    grunt.registerTask('sync', ['concat:dataSync']);
